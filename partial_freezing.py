...
================================
Trains with varying numbers of unfrozen transformer layers
to find the optimal depth for fine-tuning.
"""
import os
import json
import shutil
...
from src.train_utils import get_data_collator, set_seed
...
# ============================================================
# 3. DATA COLLATOR & METRICS (from centralised src/)
# ============================================================
...
if config.get("optuna", {}).get("enabled", False):
    ...
    from src.model_utils import get_model as _get_model
